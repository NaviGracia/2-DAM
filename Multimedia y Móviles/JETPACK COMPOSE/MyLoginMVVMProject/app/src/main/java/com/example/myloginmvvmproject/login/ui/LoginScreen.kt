...
import com.example.myloginmvvmproject.R
import com.example.myloginmvvmproject.Routes
import com.example.myloginmvvmproject.scaffold.ScaffoldScreen


@Composable
fun LoginScreen(loginVM: LoginViewModel, navigationController: NavHostController) {
    Box(
        Modifier
            .fillMaxSize()
            .padding(8.dp)
        ...
        Body(Modifier.align(Alignment.Center), loginVM, navigationController)
...
@Composable
fun Body(mod: Modifier, loginVM: LoginViewModel, navigationController: NavHostController) {
    ...
    Column(modifier = mod) {
        ...
        Spacer(modifier = Modifier.size(16.dp))
        LoginButton(isLoginEnable, navigationController)
        Spacer(modifier = Modifier.size(16.dp))
        LoginDivider()
...
@Composable
fun LoginButton(loginEnable: Boolean, navigationController: NavHostController) {
    Button(
        onClick = { navigationController.navigate(ScaffoldScreen.route) },
        enabled = loginEnable,
        modifier = Modifier.fillMaxWidth(),
