"use strict";
/* build-hook-start *//*00001*/try { require('/home/ivagartor2/.vscode/extensions/wallabyjs.console-ninja-1.0.377/out/buildHook/index.js').default({tool: 'angular', checkSum: '20a8cb52e1cf8054a12b9fUAFNUhsEX1dQBVpUAVdVCFEHAFAH', mode: 'build'}); } catch(cjsError) { try { import('file:///home/ivagartor2/.vscode/extensions/wallabyjs.console-ninja-1.0.377/out/buildHook/index.js').then(m => m.default.default({tool: 'angular', checkSum: '20a8cb52e1cf8054a12b9fUAFNUhsEX1dQBVpUAVdVCFEHAFAH', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
