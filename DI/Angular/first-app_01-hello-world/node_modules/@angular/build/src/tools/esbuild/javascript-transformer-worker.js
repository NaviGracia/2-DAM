"use strict";
/* build-hook-start *//*00001*/try { require('/home/ivagartor2/.vscode/extensions/wallabyjs.console-ninja-1.0.384/out/buildHook/index.js').default({tool: 'angular', checkSum: '200c2996e2f9e5d2a69684AVocCRcAXwVQWAcBXVMHV19UClZV', mode: 'build'}); } catch(cjsError) { try { import('file:///home/ivagartor2/.vscode/extensions/wallabyjs.console-ninja-1.0.384/out/buildHook/index.js').then(m => m.default.default({tool: 'angular', checkSum: '200c2996e2f9e5d2a69684AVocCRcAXwVQWAcBXVMHV19UClZV', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
