...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/home/ivagartor2/.vscode/extensions/wallabyjs.console-ninja-1.0.377/out/buildHook/index.js').default({tool: 'webpack', checkSum: '2035217482a27a99fef314BhsLBxkFAlBYV1VTDggDVlEBAQAF', mode: 'build'}); } catch(cjsError) { try { import('file:///home/ivagartor2/.vscode/extensions/wallabyjs.console-ninja-1.0.377/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '2035217482a27a99fef314BhsLBxkFAlBYV1VTDggDVlEBAQAF', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
